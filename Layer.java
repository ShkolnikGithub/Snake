...
public class Layer extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        g.fillRect(Room.game.getWidth() * 0, 0, 10, (Room.game.getWidth() * 10) + 10);  //Рисуем прямоугольник показывающий край поля слева

        g.fillRect(0, 0, (Room.game.getHeight() * 10) + 10, 10); //Рисуем прямоугольник показывающий край поля сверху
